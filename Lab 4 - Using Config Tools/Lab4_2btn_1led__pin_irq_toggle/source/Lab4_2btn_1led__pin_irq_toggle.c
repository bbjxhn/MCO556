...
/* clear interrupt flag set by button SW2 connected to pin PTC6 */
	...
	LED_BLUE_TOGGLE(); /* toggle the onboard blue colour LED */
...
int main(void) {
	...
	*/
    ...
    PRINTF("Lab4_Part 6 - John Trinidad");
    PRINTF("\nPress SW2 to toggle BLUE LED");
    PRINTF("\nPress SW3 to toggle pin PTC16");
